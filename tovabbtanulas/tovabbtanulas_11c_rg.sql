...
CREATE TABLE `altalanos_iskola` (
  ...
  `altalanos_iskola_neve` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `altalanos_iskola_cime` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL
